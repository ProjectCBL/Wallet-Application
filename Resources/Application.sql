...
--Dummy 
INSERT INTO Customer(customerId, userName, password, email, firstName, lastName, walletBalance, savingBalance) VALUES
    (1, "Admin", "D6!aeYic%De5J3", "admin@mail.com", "Christopher", "Bessette-Lee", 150.00, 72.00);

INSERT INTO Transaction(transactionId, customerId, type, dateOfTransaction, walletBalanceBefore, savingBalanceBefore, walletBalanceAfter, savingBalanceAfter, source, destination) VALUES
